...
LLM_CONFIG = {
    ...
    "google_credentials_path": os.path.expanduser("~/your-pattern/credentials/vertex-ai-key.json"),

    # Generation Settings
    "max_tokens": 500,
    "temperature": 0.7,
    "fallback_order": ["grok", "openai", "vertex"]  # Try Grok first, then OpenAI, then Vertex
}
...
SLIM_KNOWLEDGE_CONFIG = {
    ...
    "mega_slim_agent_docs": Path("/home/jeremy/your-pattern/RAG-doc-data/MEGA-SLIM-Agent"),
    "priority_topics": [
